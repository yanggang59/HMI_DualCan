...
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? 4? 27 17:17:50 2019
# Project:  har5.pro
# Template: app
...
SOURCES       = src/can_recv_send.cpp \
		...
		src/tachmeter.cpp \
		src/thread.cpp moc/moc_controlsetting.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/har51.0.0/ && $(COPY_FILE) --parents header/can_recv_send.h header/controlsetting.h header/cutheight.h header/engtach.h header/mqlabel.h header/mydashboard.h header/mylcdnumber.h header/myprogressbar.h header/mywidget.h header/numkeyboard.h header/parametersetting.h header/softkeylineedit.h header/tachmeter.h header/thread.h header/controlsetting.h obj/har51.0.0/ && $(COPY_FILE) --parents src/image.qrc obj/har51.0.0/ && $(COPY_FILE) --parents src/can_recv_send.cpp src/controlsetting.cpp src/cutheight.cpp src/engtach.cpp src/main.cpp src/mqlabel.cpp src/mydashboard.cpp src/mylcdnumber.cpp src/myprogressbar.cpp src/mywidget.cpp src/numkeyboard.cpp src/parametersetting.cpp src/softkeylineedit.cpp src/tachmeter.cpp src/thread.cpp obj/har51.0.0/ && $(COPY_FILE) --parents forms/controlsetting.ui forms/mywidget.ui forms/parametersetting.ui obj/har51.0.0/ && (cd `dirname obj/har51.0.0` && $(TAR) har51.0.0.tar har51.0.0 && $(COMPRESS) har51.0.0.tar) && $(MOVE) `dirname obj/har51.0.0`/har51.0.0.tar.gz . && $(DEL_FILE) -r obj/har51.0.0
